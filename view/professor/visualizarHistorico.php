...
?>
    ...
    <?php
            ...
            if ($resultado->num_rows > 0) {
                ...
                echo "<p class='p-monitor'><strong>Histórico: </strong> " . $historico . "</p>";
                echo "<a class='btnClean' class='btn btn-primary' href='excluirHistorico.php?id_historico=$rowm[id_historico]'>
